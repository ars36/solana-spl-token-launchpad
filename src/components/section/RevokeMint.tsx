...
const RevokeMint = () => {
    ...
    async function revokeMintAuthority(
        ...
        if (wallet.publicKey != null) {
            ...
            transaction.add(createSetAuthorityInstruction(mintAddress, wallet.publicKey, AuthorityType.MintTokens, null));
    ...
    const revokeMint = () => {
        revokeMintAuthority(SOLANA_CONNECTION, wallet, mintaddress);
    }


    return (
        <S.LearnButton onClick={revokeMint}>Revoke Mint authority</S.LearnButton>
    )
